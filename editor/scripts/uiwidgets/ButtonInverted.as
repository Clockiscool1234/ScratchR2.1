package uiwidgets
{
   ...
   public class ButtonInverted extends Sprite
   {
      ...
      public function ButtonInverted(param1:String, param2:Function = null, param3:Boolean = false, param4:String = null)
      {
         super();
         this.action = param2;
         this.compact = param3;
      ...
      public function setMinWidthHeight(param1:int, param2:int) : void
      {
         ...
         if(this.labelOrIcon != null)
         {
            if(this.labelOrIcon is TextField)
            {
               param1 = Math.max(this.minWidth,this.labelOrIcon.width + 11);
