package util
{
   ...
   public class GIFDecoder
   {
      ...
      private function getPixels(param1:BitmapData) : Array
      {
         var _loc6_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = new Array(this.image.width * this.image.height);
         var _loc3_:* = 0;
         ...
         while(_loc7_ < _loc5_)
         {
            ...
            while(_loc8_ < _loc4_)
            {
               _loc6_ = int(param1.getPixel32(_loc8_,_loc7_));
      ...
      private function transferPixels() : void
      {
         ...
         if(this.lastDispose > 0)
         {
            if(this.lastDispose == 3)
            {
               ...
               this.lastImage = _loc6_ >= 0 ? this.frames[_loc6_] : null;
            }
            if(this.lastImage != null)
            {
               this.bitmap.copyPixels(this.lastImage,this.bitmap.rect,this.origin,null,null,true);
               if(this.lastDispose == 2)
               {
                  _loc7_ = this.transparency ? 0 : this.lastBgColor;
                  this.bitmap.fillRect(this.bitmap.rect,_loc7_);
               }
            }
         }
         ...
         while(_loc5_ < this.ih)
         {
            ...
            _loc8_ += this.iy;
            if(_loc8_ < this.height)
            {
               _loc9_ = _loc8_ * this.width;
               _loc10_ = _loc9_ + this.ix;
               _loc11_ = _loc10_ + this.iw;
               if(_loc9_ + this.width < _loc11_)
               {
                  _loc11_ = _loc9_ + this.width;
               }
               _loc12_ = int(_loc5_ * this.iw);
               while(_loc10_ < _loc11_)
               {
                  _loc13_ = this.pixels[_loc12_++] & 0xFF;
                  _loc14_ = int(this.act[_loc13_]);
                  if(_loc14_ != 0)
                  {
                     _loc1_[_loc10_] = _loc14_;
                  }
                  _loc10_++;
               }
            }
      ...
      private function decodeImageData() : void
      {
         ...
         _loc14_ = _loc10_ = _loc12_ = _loc16_ = _loc17_ = int(_loc19_ = _loc18_ = 0);
         _loc13_ = 0;
      ...
      private function readColorTable(param1:int) : Array
      {
         ...
         else
         {
            ...
            while(_loc6_ < param1)
            {
               ...
               _loc3_[_loc6_++] = 0xFF000000 | _loc8_ << 16 | _loc9_ << 8 | _loc10_;
            }
         }
         return _loc3_;
      }
      ...
      private function readImage() : void
      {
         ...
         ++this.frameCount;
         this.image = this.bitmap = new BitmapData(this.width,this.height);
         this.transferPixels();
         this.frames.push(this.bitmap);
         if(this.transparency)
         {
