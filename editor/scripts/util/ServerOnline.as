package util
{
   ...
   public class ServerOnline extends Server
   {
      ...
      {
         var _loc4_:String = URLs.assetPrefix + URLs.internalAPI + "asset/" + param1 + "/set/";
      ...
      {
         var _loc1_:String = ScratchOnline.app.getCdnToken();
         if(_loc1_)
         {
            _loc1_ = "__" + _loc1_ + "__/";
         }
      ...
      {
         var _loc2_:String = this.getCdnStaticSiteURL() + "locale/" + "lang_list.txt";
         serverGet(_loc2_,param1);
      }
      
      override public function getPOFile(param1:String, param2:Function) : void
      {
         var _loc3_:String = this.getCdnStaticSiteURL() + "locale/" + param1 + ".po";
         serverGet(_loc3_,param2);
      }
      ...
      override public function getSelectedLang(param1:Function) : void
      {
         ...
         gotLanguage = function(param1:String):void
         {
            ...
            if(param1)
            {
               ...
               if(Boolean(_loc2_) && _loc2_.lang is String)
               {
      ...
      {
         if(param3.status == 403 && Boolean(param2))
         {
