package grabcut
{
   ...
   public class CModule
   {
      ...
      public function CModule(param1:Object, param2:Function, param3:Array, param4:String)
      {
         ...
         this.oncep = (workerClass ? workerClass.current.getSharedProperty("flascc." + param4 + ".oncep") : 0) || sbrk(1,1);
         if(recordFixups)
         {
      ...
      {
         return grabcut.throwWhenOutOfMemory;
      }
      ...
      public static function getSymsUsingMD() : Array
      {
         ...
         {
            var _temp_1:* = _loc5_;
            _loc1_ = _loc1_.concat(_temp_1.getSymsUsingMDWithExplicitSyms(_loc3_));
         }
         return _loc1_;
      }
      ...
      public static function allocDataSect(param1:String, param2:String, param3:int, param4:int) : int
      {
         ...
         if(workerClass)
         {
            var _temp_1:* = "flascc.sect." + param1 + "." + param2;
            _loc5_ = int(workerClass.current.getSharedProperty(_temp_1));
         }
         if(!_loc5_)
         {
            if(param4 < 1)
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Vector$object = getModuleVector().reverse();
      ...
      private function mapCsymsWithExplicitValues(param1:Dictionary) : void
      {
         ...
         if(modSyms)
         {
            ...
            while(_loc12_ < modSyms.length)
            {
               ...
               if(_loc4_.length >= 4)
               {
                  var _temp_2:* = _loc4_[0];
                  _loc8_ = _loc4_[1];
                  _loc16_ = _loc4_[2];
                  _loc3_ = uint(_loc4_[3]);
                  if(_temp_2 == "t")
                  {
                     var _temp_3:* = new Namespace(modPackage);
                     _loc15_ = uint(script._temp_3::[_loc8_]);
                  }
                  else
                  {
         ...
         {
            var _temp_6:* = (_loc10_ = CModule.describeType(script))..metadata.(@name == "Csym");
            for each(var _loc14_ in _temp_6)
            {
               ...
               if(!(!_loc7_ || _loc7_.name() != "constant"))
               {
                  ...
                  if(_loc11_.length() >= 4)
                  {
                     _loc5_ = [];
                     var _loc24_:int = 0;
                     var _loc23_:XMLList = _loc11_;
                     for each(_loc24_ in _loc23_)
                     {
                        _loc5_.push(String((_loc24_).@value));
                     }
                     var _loc18_:String = _loc7_.@name;
                     var _temp_12:* = new Namespace(String(_loc7_.@uri));
                     _loc15_ = uint(script._temp_12::[_loc18_]);
      ...
      private function getSymsUsingMDWithExplicitSyms(param1:Dictionary) : Array
      {
         ...
         if(modSyms)
         {
            ...
            while(_loc14_ < modSyms.length)
            {
               ...
               else
               {
                  ...
                  if(_loc15_ == "t")
                  {
                     var _temp_2:* = new Namespace(modPackage);
                     _loc18_ = uint(_loc13_._temp_2::[_loc9_]);
                  }
                  else
                  {
         ...
         {
            var _temp_5:* = (_loc11_ = CModule.describeType(_loc13_))..metadata.(@name == "Csym");
            for each(var _loc16_ in _temp_5)
            {
               _loc6_ = [];
               var _loc28_:int = 0;
               ...
               if(_loc8_ && _loc8_.name() == "constant")
               {
                  ...
                  var _temp_9:* = new Namespace(String(_loc8_.@uri));
                  _loc18_ = uint(_loc13_._temp_9::[_loc22_]);
      ...
      {
         var _loc3_:Namespace = new Namespace("grabcut");
         seenModuleInit = true;
