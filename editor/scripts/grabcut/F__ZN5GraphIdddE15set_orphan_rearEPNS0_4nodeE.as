package grabcut
{
   ...
   public function F__ZN5GraphIdddE15set_orphan_rearEPNS0_4nodeE() : void
   {
      var _temp_1:* = this;
      var _loc3_:int = 0;
      var _loc1_:int = 0;
      ...
      si32(_loc1_,_loc2_);
      ESP = _loc2_;
      F__ZN6DBlockIN5GraphIdddE7nodeptrEE3NewEv();
      _loc2_ += 16;
      _loc1_ = eax;
      ...
      si32(_loc4_,_loc1_);
      _loc1_ = li32(_loc3_ - 4);
      _loc1_ = li32(_loc1_ + 76);
      if(_loc1_ != 0)
      {
         var _temp_5:* = li32(li32(_loc3_ - 4) + 76);
         si32(_loc4_ = li32(_loc3_ - 12),_temp_5 + 4);
      }
      else
      {
         si32(li32(_loc3_ - 12),li32(_loc3_ - 4) + 72);
      }
      _loc1_ = li32(_loc3_ - 12);
      _loc4_ = li32(_loc3_ - 4);
      si32(_loc1_,_loc4_ + 76);
      _loc1_ = li32(_loc3_ - 12);
      si32(0,_loc1_ + 4);
      _loc2_ = _loc3_;
      ESP = _loc2_;
