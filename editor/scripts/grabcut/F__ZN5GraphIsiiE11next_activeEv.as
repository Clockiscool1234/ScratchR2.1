package grabcut
{
   ...
   public function F__ZN5GraphIsiiE11next_activeEv() : void
   {
      var _temp_1:* = this;
      var _loc3_:int = 0;
      var _loc1_:int = 0;
      ...
      while(true)
      {
         ...
         if(_loc1_ != 0)
         {
            var _temp_5:* = li32(li32(_loc3_ - 4) + 52);
            si32(_temp_5,_loc3_ - 20);
            si32(_temp_5,li32(_loc3_ - 4) + 48);
            _loc1_ = li32(_loc3_ - 4);
            var _loc4_:int = li32(_loc1_ + 60);
         ...
         if(_loc1_ == _loc4_)
         {
            ...
            si32(li32(_loc4_ + 56),_loc4_ + 48);
         }
         else
         {
            si32(li32(li32(_loc3_ - 20) + 8),li32(_loc3_ - 4) + 48);
         }
