package grabcut
{
   ...
   public function F__ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPij() : void
   {
      var _temp_1:* = this;
      var _loc3_:int = 0;
      var _loc1_:int = 0;
      ...
      if(_loc1_ != 0)
      {
         var _temp_4:* = li32(_loc3_ - 4);
         var _temp_3:* = li32(_loc3_ - 8);
         var _temp_2:* = li32(_loc3_ - 12);
         _loc2_ -= 16;
         si32(_temp_2,_loc2_ + 8);
         si32(_temp_3,_loc2_ + 4);
         si32(_temp_4,_loc2_);
         ESP = _loc2_;
         F__ZN9__gnu_cxx13new_allocatorIiE10deallocateEPij();
         _loc2_ += 16;
      }
      _loc2_ = _loc3_;
      ESP = _loc2_;
