package grabcut
{
   ...
   public function F__ZNSt12_Vector_baseIiSaIiEEC2EjRKS0_() : void
   {
      var _temp_1:* = this;
      var _loc3_:int = 0;
      var _loc4_:int = 0;
      ...
      while(true)
      {
         try
         {
            if(!_loc4_)
            {
               ...
               si32(_loc11_,_loc3_ - 68);
               _loc1_ = li32(_loc3_ - 60);
               _loc2_ -= 16;
               si32(_loc11_,_loc2_ + 4);
               si32(_loc1_,_loc2_);
               ESP = _loc2_;
               F__ZNSt12_Vector_baseIiSaIiEE12_Vector_implC1ERKS0_();
               _loc2_ += 16;
               _loc10_ = li32(_loc3_ - 64);
               _loc9_ = li32(_loc3_ - 60);
               si32(grabcut_2F_var_2F_folders_2F_6q_2F_k8f6r3f11mz7vklyw3c3_thc0000gn_2F_T_2F__2F_ccJkt6Tg_2E_o_3A_867FA3D3_2D_F96E_2D_404D_2D_9DBB_2D_0ACB3EFD0AC6.L_LSDA_46,_loc3_ - 28);
