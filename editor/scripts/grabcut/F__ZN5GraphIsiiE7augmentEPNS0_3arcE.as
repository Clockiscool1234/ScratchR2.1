package grabcut
{
   ...
   public function F__ZN5GraphIsiiE7augmentEPNS0_3arcE() : void
   {
      var _temp_1:* = this;
      var _loc3_:int = 0;
      var _loc1_:int = 0;
      ...
      while(true)
      {
         ...
         if(si16(li16(li32(li32(_loc3_ - 16) + 8) + 12)) < li32(_loc3_ - 20))
         {
            si32(si16(li16(li32(li32(_loc3_ - 16) + 8) + 12)),_loc3_ - 20);
         }
      ...
      while(true)
      {
         ...
         if(si16(li16(li32(_loc3_ - 16) + 12)) < li32(_loc3_ - 20))
         {
            si32(si16(li16(li32(_loc3_ - 16) + 12)),_loc3_ - 20);
         }
         _loc1_ = li32(_loc3_ - 16);
         _loc1_ = li32(_loc1_);
         si32(_loc1_,_loc3_ - 12);
      ...
      _loc1_ = li32(_loc3_ - 8);
      _loc1_ = li32(_loc1_ + 8);
      var _loc5_:int = li16(_loc1_ + 12);
      var _loc4_:int = li16(_loc3_ - 20);
      _loc5_ += _loc4_;
      si16(_loc5_,_loc1_ + 12);
      _loc1_ = li32(_loc3_ - 8);
      _loc4_ = li16(_loc1_ + 12);
      _loc5_ = li16(_loc3_ - 20);
      ...
      while(true)
      {
         ...
         _loc1_ = li32(_loc3_ - 16);
         _loc5_ = li16(_loc1_ + 12) + li16(_loc3_ - 20);
         si16(_loc5_,_loc1_ + 12);
         _loc1_ = li32(li32(_loc3_ - 16) + 8);
         _loc5_ = li16(_loc1_ + 12) - li16(_loc3_ - 20);
         si16(_loc5_,_loc1_ + 12);
         if(li16(li32(li32(_loc3_ - 16) + 8) + 12) == 0)
         {
            ...
            si32(_temp_9,_loc2_);
            ESP = _loc2_;
            F__ZN5GraphIsiiE16set_orphan_frontEPNS0_4nodeE();
            _loc2_ += 16;
         }
         _loc1_ = li32(_loc3_ - 16);
         _loc1_ = li32(_loc1_);
