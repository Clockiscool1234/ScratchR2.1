package grabcut
{
   ...
   public function F__ZN5GraphIsiiE7maxflowEbP5BlockIiE() : void
   {
      var _temp_1:* = this;
      var _loc3_:int = 0;
      var _loc1_:int = 0;
      ...
      if(_loc1_ == 0)
      {
         ...
         si32(_temp_3,_loc2_);
         ESP = _loc2_;
         F__ZN6DBlockIN5GraphIsiiE7nodeptrEEC1EiPFvPcE();
         _loc2_ += 16;
      ...
      if(_loc1_ != 0)
      {
         ...
         ESP = _loc2_;
         F__ZN5GraphIsiiE24maxflow_reuse_trees_initEv();
         _loc2_ += 16;
      }
      else
      {
         ...
         ESP = _loc2_;
         F__ZN5GraphIsiiE12maxflow_initEv();
         _loc2_ += 16;
      }
      while(true)
      {
         ...
         if(_loc1_ == 0)
         {
            ...
            ESP = _loc2_;
            F__ZN5GraphIsiiE11next_activeEv();
            _loc2_ += 16;
            var _temp_20:* = eax;
         ...
         else
         {
            ...
            while(true)
            {
               ...
               if(li16(li32(li32(_loc3_ - 48) + 8) + 12) != 0)
               {
         ...
         if(_loc1_ != 0)
         {
            ...
            ESP = _loc2_;
            F__ZN5GraphIsiiE7augmentEPNS0_3arcE();
            _loc2_ += 16;
            while(true)
            {
               _loc1_ = li32(_loc3_ - 4);
      ...
      while(true)
      {
         ...
         if(_loc1_ != 0)
         {
            ...
            ESP = _loc2_;
            F__ZN6DBlockIN5GraphIsiiE7nodeptrEED1Ev();
            _loc2_ += 16;
