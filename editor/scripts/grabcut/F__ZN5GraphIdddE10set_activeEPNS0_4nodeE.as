package grabcut
{
   ...
   public function F__ZN5GraphIdddE10set_activeEPNS0_4nodeE() : void
   {
      var _temp_1:* = this;
      var _loc3_:int = 0;
      var _loc1_:int = 0;
      ...
      if(_loc1_ == 0)
      {
         if(li32(li32(_loc3_ - 4) + 68) != 0)
         {
            var _temp_3:* = li32(li32(_loc3_ - 4) + 68);
            var _loc4_:int;
            si32(_loc4_ = li32(_loc3_ - 8),_temp_3 + 8);
         }
         else
         {
            si32(li32(_loc3_ - 8),li32(_loc3_ - 4) + 60);
         }
