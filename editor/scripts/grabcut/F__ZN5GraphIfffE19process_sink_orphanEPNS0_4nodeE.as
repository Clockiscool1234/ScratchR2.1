package grabcut
{
   ...
   public function F__ZN5GraphIfffE19process_sink_orphanEPNS0_4nodeE() : void
   {
      var _temp_1:* = this;
      var _loc4_:int = 0;
      var _loc2_:int = 0;
      ...
      while(true)
      {
         ...
         if(lf32(li32(_loc4_ - 24) + 12) != 0)
         {
            var _temp_2:* = li32(li32(_loc4_ - 24));
            si32(_temp_2,_loc4_ - 20);
            while(true)
            {
               if((li8(_temp_2 + 20) & 1) != 0)
               {
                  var _temp_3:* = li32(li32(_loc4_ - 20) + 4);
                  si32(_temp_3,_loc4_ - 32);
                  if(_temp_3 != 0)
                  {
               ...
               while(true)
               {
                  ...
                  else
                  {
                     ...
                     if(li32(_loc4_ - 32) == 1)
                     {
                        ...
                        var _temp_6:* = li32(_loc4_ - 20);
                        si32(_loc8_,_temp_6 + 16);
                     }
                     else
                     {
                        if(li32(_loc4_ - 32) != 2)
                  ...
                  {
                     var _temp_8:* = li32(_loc4_ - 40);
                     if((_loc7_ = li32(_loc4_ - 36)) < _temp_8)
                     {
      ...
      {
         var _temp_12:* = li32(_loc4_ - 4);
         var _temp_11:* = li32(_loc4_ - 8);
         _loc3_ -= 16;
         si32(_temp_11,_loc3_ + 4);
         si32(_temp_12,_loc3_);
         ESP = _loc3_;
         ...
         while(true)
         {
            ...
            var _temp_20:* = li32(li32(_loc4_ - 24));
            si32(_temp_20,_loc4_ - 20);
            while(true)
            {
               if((li8(_temp_20 + 20) & 1) != 0)
               {
                  var _temp_21:* = li32(li32(_loc4_ - 20) + 4);
                  si32(_temp_21,_loc4_ - 32);
                  if(_temp_21 != 0)
                  {
                     si8(1,_loc4_ - 9);
                     break;
               ...
               if(_loc2_ != 1)
               {
                  if(li32(_loc4_ - 32) != 2)
                  {
                     if(li32(li32(_loc4_ - 32)) == li32(_loc4_ - 8))
                     {
                        ...
                        var _temp_25:* = li32(_loc4_ - 20);
                        _loc3_ -= 16;
                        si32(_temp_25,_loc3_ + 4);
                        si32(_temp_26,_loc3_);
                        ESP = _loc3_;
