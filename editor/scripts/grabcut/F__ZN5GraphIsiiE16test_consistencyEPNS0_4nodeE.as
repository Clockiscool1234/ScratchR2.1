package grabcut
{
   ...
   public function F__ZN5GraphIsiiE16test_consistencyEPNS0_4nodeE() : void
   {
      var _temp_1:* = this;
      var _loc3_:int = 0;
      var _loc1_:int = 0;
         ...
         if(_loc1_ != 0)
         {
            ...
            if(li32(_loc3_ - 24) <= 1)
            {
               ...
               if(li32(int(li32(_loc3_ - 4) + _temp_6) + 56) != li32(_loc3_ - 16))
               {
                  ...
                  si32(grabcut_2F_var_2F_folders_2F_6q_2F_k8f6r3f11mz7vklyw3c3_thc0000gn_2F_T_2F__2F_ccVQcwCy_2E_o_3A_DB5CD35D_2D_786A_2D_4530_2D_A5AF_2D_7287B409CF40.__ZZN5GraphIsiiE16test_consistencyEPNS0_4nodeEE8__func__,_loc2_);
                  ESP = _loc2_;
                  F___assert();
                  _loc2_ += 16;
               }
      ...
      while(true)
      {
         ...
         if(li32(li32(_loc3_ - 16) + 4) != 0)
         {
            if(li32(li32(_loc3_ - 16) + 4) != 2)
            {
               ...
               {
                  if(si16(li16(li32(li32(li32(_loc3_ - 16) + 4) + 8) + 12)) <= 0)
                  {
                     _loc2_ -= 16;
               ...
               else if(si16(li16(li32(li32(_loc3_ - 16) + 4) + 12)) <= 0)
               {
                  _loc2_ -= 16;
            ...
            if(li32(li32(_loc3_ - 16) + 8) == 0)
            {
               if((li8(li32(_loc3_ - 16) + 20) & 1) == 0)
               {
                  ...
                  while(true)
                  {
                     ...
                     if(si16(li16(li32(_loc3_ - 20) + 12)) >= 1)
                     {
               ...
               else
               {
                  ...
                  while(true)
                  {
                     ...
                     if(si16(li16(li32(li32(_loc3_ - 20) + 8) + 12)) >= 1)
                     {
                        if(li32(li32(li32(_loc3_ - 20)) + 4) != 0)
                        {
                           if((li8(li32(li32(_loc3_ - 20)) + 20) & 1) != 0)
