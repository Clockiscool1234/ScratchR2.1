   ...
   public class TopBarPart extends UIPart
   {
      ...
      protected function addButtons() : void
      {
         ...
         if(Scratch.app.isExtensionDevMode)
         {
            ...
            addChild(this.exportButton = new Button("Save Project",function():void
            {
      ...
      protected function fixLogoLayout() : int
      {
         ...
         if(this.logoButton)
         {
            ...
            this.logoButton.y = 5;
            _loc1_ += this.logoButton.width + this.buttonSpace;
         }
         return _loc1_;
      }
      ...
      protected function fixLayout() : void
      {
         ...
         _loc2_ += this.languageButton.width + this.buttonSpace;
         this.fileMenu.x = _loc2_;
         this.fileMenu.y = _loc1_;
         _loc2_ += this.fileMenu.width + this.buttonSpace;
         this.editMenu.x = _loc2_;
         this.editMenu.y = _loc1_;
         _loc2_ += this.editMenu.width + this.buttonSpace;
         var _loc3_:int = 3;
         this.copyTool.x = app.isOffline ? 493 : 427;
         ...
         this.helpTool.x = this.shrinkTool.right() + _loc3_;
