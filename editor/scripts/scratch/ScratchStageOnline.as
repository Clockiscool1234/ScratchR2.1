package scratch
{
   ...
   public class ScratchStageOnline extends ScratchStage
   {
      ...
      {
         var mio:MediaInfoOnline;
         var addSpriteForCostume:Function;
         var addDroppedSprite:Function;
         ...
         mio = obj as MediaInfoOnline;
         if(Boolean(mio) && mio.fromBackpack)
         {
            addSpriteForCostume = function(param1:ScratchCostume):void
            {
            ...
            {
               addDroppedSprite = function(param1:ScratchSprite):void
               {
