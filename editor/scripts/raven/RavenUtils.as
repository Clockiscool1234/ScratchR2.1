package raven
{
   ...
   public class RavenUtils
   {
      ...
      {
         var _loc1_:String = "";
         _loc1_ += randInt(0,65535).toString(16).substr(0,4);
         _loc1_ += randInt(0,65535).toString(16).substr(0,4);
         _loc1_ += randInt(0,65535).toString(16).substr(0,4);
         _loc1_ += (randInt(0,4095) | 0x4000).toString(16).substr(0,4);
         _loc1_ += (randInt(0,16383) | 0x8000).toString(16).substr(0,4);
         _loc1_ += randInt(0,65535).toString(16).substr(0,4);
         _loc1_ += randInt(0,65535).toString(16).substr(0,4);
         return _loc1_ + randInt(0,65535).toString(16).substr(0,4);
      }
      ...
      public static function formatTimestamp(param1:Date) : String
      {
         ...
         _loc2_ += _loc3_ < 10 ? "0" + _loc3_ + "-" : _loc3_ + "-";
         _loc2_ += param1.dateUTC + "T";
         _loc2_ += param1.hoursUTC + ":";
         _loc2_ += param1.minutesUTC + ":";
         return _loc2_ + param1.secondsUTC;
      }
   }
}
