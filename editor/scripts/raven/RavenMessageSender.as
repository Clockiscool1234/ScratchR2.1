package raven
{
   ...
   public class RavenMessageSender
   {
      ...
      private var messagesSent:Object = new Object();
      ...
      public function send(param1:String, param2:Number, param3:String) : void
      {
         ...
         signature = RavenUtils.getSignature(message,timestamp,this._config.privateKey);
         ...
         request = new URLRequest(this._config.uri + "api/" + this._config.projectID + "/store/");
      ...
      {
         var _loc3_:String = "Sentry sentry_version=2.0,sentry_signature=";
         _loc3_ += param1;
         _loc3_ += ",sentry_timestamp=";
         _loc3_ += param2;
         _loc3_ += ",sentry_key=";
         _loc3_ += this._config.publicKey;
         _loc3_ += ",sentry_client=";
         return _loc3_ + RavenClient.NAME;
      }
