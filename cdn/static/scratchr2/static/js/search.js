	...
	var player = ' \
		<div id="search_preview_player"> \
             <object id="scratch" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"> \
	          	<param name="movie" value="'+ static_path + 'Scratch.swf" /> \
				...
				<param name="FlashVars" value="autostart=true"> \
	          	<!--[if !IE]>--> \
	          	<object type="application/x-shockwave-flash" data="'+ static_path + 'Scratch.swf" width="100%" height="100%"> \
		         	<param name="allowScriptAccess" value="sameDomain"> \
		          	<param name="allowFullScreen" value="true"> \
