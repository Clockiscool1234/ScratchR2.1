...
$(function () {
  ...
  /* JUST FOR HOUR OF CODE - REMOVE AFTER */  
    /* listens for click on "join scratch" from tips window" */
    /* Event handler for tips window controlling editor js */
    ...
    eventer(messageEvent,function(e) {
      console.log('blah');
      console.log(e);
      if (e.message == "registration-modal" || e.data == "registration-modal") {

        $('[data-control="registration"]').trigger('click');
        Scratch.FlashApp.lastEditorOp = 'save';
      }
      // //run function//
    },false);
