...
Scratch.Gallery.Projects = Scratch.Gallery.Projects || {};

Scratch.Gallery.Projects.Router = Backbone.Router.extend({
  routes: {
      ""            :  "projects",
  },
  ...
  initialize: function() {
    ...
    this.galleryEditTitle = new Scratch.Gallery.EditableField({model: this.galleryModel, gallery_id: Scratch.INIT_DATA.GALLERY.model.id, el: '#title'});
    this.galleryEditDescription = new Scratch.Gallery.EditableField({model: this.galleryModel, gallery_id: Scratch.INIT_DATA.GALLERY.model.id, el: '#description'});
...
$(function() {
  app = new Scratch.Gallery.Projects.Router();
